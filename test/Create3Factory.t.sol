...
contract Create3FactoryTest is Test {
    ...
    bytes SimpleStoreBytecode = bytes(abi.encodePacked(0x602d8060093d393df35f3560e01c8063552410771461001e5780632096525514610024575f5ffd5b6004355f555b5f545f5260205ff3));
)
    ...
    function testDeploy(bytes32 salt) public {
        factory.deploy(salt, SimpleStoreBytecode);
        address addr = factory.getDeterministicAddress(salt);
        console.log(addr);
    }
